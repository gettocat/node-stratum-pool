...
exports.bufferToCompactBits = function (startingBuff) {
    var bigNum = new BN(startingBuff.toString('hex'), 'hex', 'be');
...
exports.bignumFromBitsBuffer = function (bitsBuff) {
    ...
    var p = parts(parseInt(bitsBuff.toString('hex'), 16)), F = new BN(8 * (p[0] - 3), 10), tmp = new BN(2, 10).pow(F), R = new BN(p[1], 10).mul(tmp);
    return R;
};
